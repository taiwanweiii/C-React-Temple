...
namespace Server.Services
{
    ...
    public class LineBotServices : ControllerBase
    {
        ...
        private readonly ILogger<LineBotServices> _logger;

        public LineBotServices(IConfiguration configuration, ILogger<LineBotServices> logger)
        {
        ...
        public async Task<IActionResult> ReplyMessage()
        {
            ...
            _logger.LogInformation("收到LINE訊息：{Json}", json);
